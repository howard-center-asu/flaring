...
Annual data for Colorado needed to be downloaded year-to-year, compiled, then cleaned. For a copy of this data cleaning, contact Jimmy Cloutier at [jclouti3@asu.edu](mailto:jclouti3@asu.edu). The compiled data was saved as an .csv to the project directory. 
...
co <- read.csv("co_flaring_and_venting.csv")
