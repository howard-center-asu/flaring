...
Each state and several auxilliary fact-checking analyses are included here. Some of the original raw data files were too large to include here. The pre-processing and original source is documented in each state's page. The raw markdown files are available at <https://github.com/howard-center-asu/gaslit>. 
...
* [Fort Berthold](fort_berthold_indian_reservation_flaring.Rmd) Indian Reservation analysis, in North Dakota (in raw markdown form)
* [Census demographics](tx_census_flaring.Rmd) for Texas flaring and venting (raw markdown form). 
