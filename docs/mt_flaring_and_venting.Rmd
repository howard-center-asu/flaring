...
We cleaned the data and ensured there were no duplicates then saved it as a csv file: `mt_flaring_and_venting.csv` 


```{r load_and_clean_data, echo=TRUE}


mont <- read.csv("mt_flaring_and_venting.csv")
