...
To calculate the number of completions during the governor's administration, we filtered `compl_date` variable, identifying the date of the completion, for the years 2019 to 2021. To ensure we count unique well completions, we use `n_distincit` to count records that were distinct by well number, `api`, and the `compl_date`. 
