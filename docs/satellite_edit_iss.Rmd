...
I THINK WE NEED TO TALK ABOUT MIDSTREAM BEING INCLUDED IN UPSTREAM SHEET HERE
...
county_flares_table <- county_flares_table %>% #IS IT BEST PRACTICE TO BE SAVING OVER A DATA FRAME LIKE THIS?
...
WE NEED BETTER REFERENCE POINT THAN SHEA AND AMY
...
IF ITS CORPORATION OWNED I"M NOT SURE WE CAN DESCRIBE IT AS TRIBAL LAND, CAN WE????
...
?????? WHERE DID WE GET OUR CONVERSION NUMBER ??????
